    ...
    return (
        <div>
            ...
            <div className="text-xs text-gray-500 mb-2">
                Ride ID: {props.ride.rideId || props.ride._id || 'Not found'}
            </div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-5 w-full '>
                    <button onClick={async () => {
                        try {
                            // First, confirm the ride (accept it)
                            await props.confirmRide();
                            // Then show the OTP input panel
                            props.setConfirmRidePopupPanel && props.setConfirmRidePopupPanel(true);
                        } catch (error) {
